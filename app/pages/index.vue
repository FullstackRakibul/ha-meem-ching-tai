...
const navItems = [
  {
    label: "Home",
    href: "#top",
    image: "https://api.hameemgroup.com:9012/Resources/HCTPAL/HameemChingTai33.jpeg",
  },
  {
...
// TODO(confirm: exact commercial product names/specs for the rail — these are the
// four verified CT/HCTPAL lines, not confirmed SKU names)
...
const categoryScenes = [
  {
    ...
    title: "Pocketing",
    description:
      "Built to international specification. Jersey, poly/cotton (TC), 100% cotton and 100% polyester pocketing across a range of weaves and constructions.",
  ...
  },
  {
    ...
    title: "Interlining",
    description:
      "Woven, non-woven and knitted interlining in fusible and non-fusible grades, with or without adhesive, for shape retention through wash and wear.",
    image: "https://api.hameemgroup.com:9012/Resources/HCTPAL/HameemChingTai17.jpeg",
    type: "cover",
  },
  {
    id: "03",
    title: "Waistband / Elastic",
    description:
      "Logo-printed woven and stretch silicone waistbands with rubber grippers. Yarn-dyed and printed qualities, insert piping and bias-binding constructions.",
    image: "https://api.hameemgroup.com:9012/Resources/HCTPAL/HameemChingTai13.jpeg",
    type: "cover",
  },
  {
    id: "04",
    title: "Lining / Taffeta",
    description:
      "Cotton, viscose and acetate linings in stretch and printed qualities. Taffeta constructions finished for drape, colour consistency and repeat order accuracy.",
  ...
  const update = () => {
    ...
    if (horizontal && sticky && track && window.innerWidth >= 840 && !reduced) {
      ...
      const active = Math.min(
        categoryScenes.length,
        Math.max(1, Math.round(progress * (categoryScenes.length - 1)) + 1)
      );
