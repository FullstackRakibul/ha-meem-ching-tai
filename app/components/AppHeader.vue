...
<template>
  <header :class="[
    ...
    <a href="#top" class="header-logo px-2 group flex flex-col shrink-0 outline-none" @click="emit('closeMenu')"
    ...
    <div class="header-links ml-auto flex items-center gap-4 shrink-0">
      ...
      <a href="/Profile_CT_BROCHURE.pdf" download="Ha-Meem-Ching-Tai-Profile.pdf" class="flex items-center gap-2">
