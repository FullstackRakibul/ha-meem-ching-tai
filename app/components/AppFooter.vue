<template>
  <footer class="relative w-full overflow-hidden bg-[#f5f5f0] pt-12 sm:pt-16 md:pt-24">
    <UContainer>
      ...
      <!-- ================= Watermark ================= -->
      <!-- Sized with cqw (container width) rather than vw so it scales to the
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-12 gap-x-6 sm:gap-x-8 gap-y-8 sm:gap-y-10 pt-10 sm:pt-0 pb-10 sm:pb-14">
        ...
        <!-- 3 columns × 2 + Offices 3 + brand 3 = 12 -->
        <div
        ...
        >
          ...
          <ul class="space-y-3 text-sm sm:text-[15px]">
            <li v-for="link in column.links" :key="link">
              <a
                href="#"
                class="text-gray-500 hover:text-secondary transition-colors duration-300"
                >{{ link }}</a
              >
            </li>
          </ul>
...
const columns = [
  {
    title: "Company",
    links: ["About", "Why It Matters", "The Facility", "Milestones"],
  },
  {
    title: "Products",
    links: ["Pocketing Fabric", "Interlinings", "Labels & Tapes", "Packaging"],
  },
  {
    title: "Connect",
    links: ["Contact", "LinkedIn", "Careers"],
  },
];
</script>
